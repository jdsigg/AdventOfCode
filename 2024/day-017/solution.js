...
// To calculate this yourself, run your program until, looking at the first character of outputs until the subsequence repeats itself.
...
while(queue.length > 0) {
    ...
    for(const position of numbersToSequencePosition[programNumbers[programIndex]]) {
        // We need to find the closest possible sequence to rangeStart
